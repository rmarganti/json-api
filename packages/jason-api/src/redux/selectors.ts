...
import { ResourceObject, pipe } from 'ts-json-api';

import { ResponseShape } from '../types/request';
import { StateWithJasonApi } from '../types/state';
import { isUndefined, mapOrOnce, simplifyResourceObjects } from '../utils/data';
 ...
 */
export const getCachedQuery = <Data = any>(
    state: StateWithJasonApi,
    key: string,
    expandResourceObjects: boolean = false
): ResponseShape<Data> | undefined => {
